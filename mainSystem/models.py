...
class OqitishSifati(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    talim_sifat_xulosasi = models.DecimalField(null=True, blank=True, verbose_name="Baholash",max_digits=2,decimal_places=1)
    talim_sifat = models.DecimalField(null=True, blank=True, verbose_name="Baholash",max_digits=2,decimal_places=1)
    score = models.DecimalField(null=True, blank=True, verbose_name="Umumiy ball", editable=False,max_digits=2,decimal_places=1)
...
class DarslikYokiQollanma(models.Model):
    ...
    link = models.URLField(verbose_name="Maqolaga havola")
    score = models.DecimalField(null=True, blank=True, verbose_name="Baholash",max_digits=2,decimal_places=1)  # Superuser reytingi
    izoh = models.TextField()
